...
object AgentBusinessNameForm:

  val key: String = "agentBusinessName"
  val otherKey: String = "otherAgentBusinessName"
  val form: Form[AgentBusinessName] = Form(
    mapping =
      mapping(
        ...
        otherKey -> mandatoryIf(
          ...
          text
            ...
            .verifying(
              ...
              value => AgentBusinessName.isValidEntry(value)
            )
        )
      )(AgentBusinessName.apply)(a => Some((a.agentBusinessName, a.otherAgentBusinessName)))
  )
